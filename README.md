...
Para inicializar o sistema em uma aplicação local, basta digitar no terminal:

```bash
ng serve
```

Quando estiver rodando, abra seu navegador e vá até `http://localhost:4200/`. A aplicação será rodada automáticamente
